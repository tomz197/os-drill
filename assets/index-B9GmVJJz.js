 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lz=wm("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),Sm=y.forwardRef(({className:e,...n},t)=>I.jsx(gm,{ref:t,className:Na("peer h-4 w-4 shrink-0 rounded-sm border border-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground",e),...n,children:I.jsx(oz,{className:Na("flex items-center justify-center text-current"),children:I.jsx(xm,{className:"h-4 w-4"})})}));Sm.displayName=gm.displayName;function Em({facts:e,resetQuestion:n}){const[t,o]=y.useState([]),[r,a]=y.useState(!1);function i(){o([]),a(!1),n()}return I.jsxs(I.Fragment,{children:[e.map((l,s)=>I.jsxs("div",{className:Na(["p-2 flex gap-2 items-center",s!==0&&" border-t ",r&&(l.isCorrect?"bg-green-200":"bg-red-200"),r?"cursor-default":"cursor-pointer",r?l.isCorrect?"hover:bg-green-300":"hover:bg-red-300":"hover:bg-gray-200"]),onClick:()=>{r||(t.includes(l)?o(u=>u.filter(d=>d.fact!==l.fact)):o(u=>[...u,l]))},children:[I.jsx(Sm,{id:s+"-formCheckbox",name:"checkbox",className:"pointer-events-none",checked:t.includes(l),disabled:r}),I.jsx("div",{className:"flex-1",children:I.jsx(sz,{fact:l.fact,correct:l.correct,isSubmitted:r})}),r&&t.includes(l)&&(l.isCorrect?I.jsx("span",{className:"text-green-500",children:I.jsx(xm,{className:"w-10 h-10"})}):I.jsx("span",{className:"text-red-500",children:I.jsx(lz,{className:"w-10 h-10"})}))]},s)),I.jsx(hr,{className:"w-full mt-4",onClick:()=>{if(r){i();return}a(!0)},children:r?"Další otázka":"Odeslat"})]})}function sz({fact:e,correct:n,isSubmitted:t}){const[o,r]=y.useState(!1);return I.jsxs(I.Fragment,{children:[I.jsx("p",{children:o?n:e}),t&&n&&I.jsxs("div",{className:"flex items-center pt-2 gap-2 select-none",children:[I.jsx("p",{onMouseDown:()=>r(!o),className:"font-bold underline italic cursor-pointer",children:o?"zobrazit nesprávnou":"zobrazit správnou"}),I.jsx("p",{className:"text-gray-600",children:o?"(Zobrazuje se správna odpověď)":"(Zobrazuje se nesprávna odpověď)"})]})]})}function uz(){var r;const{section:e}=ry(),[n,t]=y.useState(null),o=y.useCallback(()=>{if(!e){console.error("Section or name not found"),Cl("/");return}const a=ld({section:parseInt(e)});if(!a){console.error("Drill not found"),Cl("/");return}t(em(a))},[e]);return y.useEffect(()=>{o()},[o]),n?I.jsxs(I.Fragment,{children:[I.jsxs("h2",{className:"text-xl",children:["Část: ",e,":"," ",e?((r=ld({section:parseInt(e)}))==null?void 0:r.name)??"":""]}),I.jsx("div",{children:I.jsx(Em,{facts:n,resetQuestion:o})})]}):null}function dz(){const[e,n]=y.useState(null),t=y.useCallback(()=>{const o=th();if(!o)return console.error("Drill not found"),Cl("/"),null;n(em(o))},[]);return y.useEffect(()=>{t()},[t]),e?I.jsxs(I.Fragment,{children:[I.jsx("h2",{className:"text-xl",children:"Všechny části"}),I.jsx("div",{children:I.jsx(Em,{facts:e,resetQuestion:t})})]}):null}const cz=Sy([{path:"/",element:I.jsx(Fy,{}),children:[{path:"",element:I.jsx(Uy,{})},{path:"zkouska/:section",element:I.jsx(uz,{})},{path:"zkouska",element:I.jsx(dz,{})}]}],{basename:"/"});Ni.createRoot(document.getElementById("root")).render(I.jsx(Vd.StrictMode,{children:I.jsx(Ly,{router:cz})}));
